<?php
/*
 * c. (2 pont) A módosító oldalon jelenjenek meg a tanár adatai:
 *  neve, vállalt óraszáma, a jelenleg hozzá rendelt gyakorlatok!
 *
 */
...
<body>
  ...
  <form action="" method="post">
    Name: <?php echo $teachers[$id]['name'] ?> <br>
    Maxcount: <input type="number" name="maxcount" value="<?php echo $teachers[$id]['maxcount'] ?>"> <br>
    Practices: <br>
